				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="/skytech_admin.php?s=user/group">用户组</a>
							</li>
							
							<li class="active">用户组权限设置</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<h3 class="header smaller lighter blue">用户组权限设置</h3>

								<!-- <div class="dataTables_borderWrap"> -->
								<form method="post" id="form_purwiews">
									
									<ul class="purwiews_set">
										<?php echo $purviews;?>
