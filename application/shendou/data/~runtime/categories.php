				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header page-header-h1">
							<h5>
								<a style="margin-right: 20px;" href="<?php echo $this->mSiteCfg['dynamic_url']['categories_add_or_update'];?>"><span class="glyphicon glyphicon-plus">添加顶级栏目</span></a>
								<a href="<?php echo $this->mSiteCfg['dynamic_url']['categories_batch_add'];?>"><span class="glyphicon glyphicon-plus">批量添加栏目</span></a>
							</h5>
						</div><!-- /.page-header -->
