	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			<div class="main-content">
				...
				'is_empty_cache' => null,
				'id' => 'list',
				'empty_str' => '<tr class="tr ct"><td colspan="8">暂无记录</td></tr>',
				'auto_index_prev' => 0,
				'db_callback' => null,
				'show_result_callback' => create_function('$item,$index','return str_replace("#autoIndex#",$index,\'
											...
											<tr>
												...
												<td width="100">
													<a href="#">\'.$item[\'id\'].\'</a>
													<span class="glyphicon glyphicon-folder-\'.($item[\'msg_isread\'] == 1 ? \'open green\' : \'close red\').\'"></span>
												</td>
												<td width="200" style="word-break: break-all;">\'.$item[\'msg_name\'].\'</td>
												<td width="150">\'.$item[\'msg_date\'].\'</td>												
												<td style="word-break: break-all;">\'.$item[\'msg_comments\'].\'</td>
												<td width="100">
													<div class="hidden-sm hidden-xs action-buttons">
														<a class="blue" href="\'.(Lamb_Utils::objectCall(CALL_ROUTER, \'urlEx\', array(\''.$this->C.'\', \'info\', array(\'id\' => $item[\'id\'])))).\'" title="详情">
															<i class="ace-icon fa fa-search-plus bigger-130"></i>
														</a>

														<a class="red del_msg" id=\'.$item[\'id\'].\'  title="删除">
