			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<h3 class="header smaller lighter blue">模板列表</h3>
								<table id="sample-table-2" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<?php foreach($ret['name'] as $key => $item) { ?>
											<tr>
												<td><?php echo $key+1;?></td>
												<td><?php echo $item;?></td>
												<td><?php echo date('Y-m-d H:i:s',$ret['filemtime'][$key]); ?></td>
												<td>
													<a class="blue template" href="/skytech_admin.php?s=template/template/path/<?php echo $item;?>">
