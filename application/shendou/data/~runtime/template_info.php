				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="/skytech_admin.php?s=template/index">模板列表</a>
							</li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<h3 class="header smaller lighter blue">模板详情</h3>
								<form method="post" id="template">
									<input type="hidden" name="path" value="<?php echo $path;?>" />
									<textarea name="content" cols="120" rows="20"><?php echo $content;?></textarea>
									
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<button class="btn btn-info" id="template_submit" type="submit">
