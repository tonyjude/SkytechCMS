	      	...
	      	<div class="row">
				...
				'show_result_callback' => create_function('$item,$index','return str_replace("#autoIndex#",$index,\'
		      	<div class="col-md-4 col-sm-6">
		      			<a title="\'.$item[\'art_title\'].\'" href="\'.($item[\'recommend\'] == 3 ? $item[\'art_url\'] : Lamb_Utils::objectCall(CALL_ROUTER, \'urlEx\', array(\'item\', \'index\', array(\'id\' => $item[\'id\'], \'art_title\' => $item[\'art_title\'])))).\'">
	        		   		<img src="\'.$item[\'art_image\'].\'" width="200" height="200"/>
	        		  </a>	
		      			<h3 class="t"><a title="\'.$item[\'art_title\'].\'" href="@me[\\\'recommend\\\'] == 3 ? @me[\\\'art_url\\\'] : Lamb_Utils::objectCall(CALL_ROUTER, \\\'urlEx\\\', array(\\\'item\\\', \\\'index\\\', array(\\\'id\\\' => @this, \\\'art_title\\\' => @me[\\\'art_title\\\'])))"}">\'.$item[\'art_title\'].\'</a></h3>
	      		</div>
	      		\');')
			))?>
	      	</div>
