			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<h3 class="header smaller lighter blue">会员列表</h3>
								<h5 style="float: right">
									<a href="?s=user/addOrUpdate">
				...
				'show_result_callback' => create_function('$item,$index','return str_replace("#autoIndex#",$index,\'
											...
											<tr>
												...
												<td>\'.($item[\'user_role\'] == 1 ? \'超级管理员\' : ($item[\'user_role\'] == 2 ? \'栏目管理员\' : \'信息发布员\') ).\'</td>
												<td>\'.$item[\'rigister_time\'].\'</td>												
												<td style="cursor:pointer;">
													<span class="lock" title="点击修改状态">\'.($item[\'status\']? \'<font color=green>正常</font>\' : \'<font color=gray>锁定</font>\').\'</span>
												</td>
											</tr>
